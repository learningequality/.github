      ...
      if (now - lastActivity > inactivityPeriodInMinutes * 60 * 1000) {
        ...
        try {
          ...
          await octokit.rest.issues.createComment({
            ...
            repo,
            issue_number: issue.number,
            body: `Automatically unassigning @${assignee.login} due to no comments here, or updates on the associated pull request for 1 month. @${assignee.login}, if you're still interested in this issue or already have work in progress, please message us here, and we'll assign you again. Thank you!`,
          });
